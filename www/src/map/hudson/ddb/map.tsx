...
// Source data CSV
export const DATA_URL = 'https://raw.githubusercontent.com/visgl/deck.gl-data/master/examples/scatterplot/manhattan.json';
...
export default function App(
    {
        ...
        radius?: number
        maleColor?: [ number, number, number ]
        femaleColor?: [ number, number, number ]
        mapStyle?: string
    }
) {
