...
export function Pedestrian({ className, style }: { className?: string, style?: CSSProperties }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="15 0 70 100"
...
export function Cyclist({ className, style }: { className?: string, style?: CSSProperties }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
...
export function Car({ className, style }: { className?: string, style?: CSSProperties }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 64 80"
