...
from .channel_client import CHANNEL_OPTS, DEFAULT_BATCH_SIZE, DEFAULT_MAX_RECS, ChannelClient
from .config import SLACK_IM_ID, SLACK_CHANNEL_ID
...
channel_opt = option(*CHANNEL_OPTS, help=f'Slack channel ID to post to; defaults to ${SLACK_CHANNEL_ID}')
im_opt = option('-i', '--im', is_flag=True, help=f'Use IM channel indicated by {SLACK_IM_ID}')
